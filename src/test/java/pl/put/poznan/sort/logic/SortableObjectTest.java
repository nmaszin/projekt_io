...
public class SortableObjectTest {
    ...
    void NullKeyTest(){
        ...
        SortableObjectKeyNotExistsException thrown= Assertions.assertThrows(SortableObjectKeyNotExistsException.class,
                ()-> {SortableObject So=new SortableObject(SimpleTestNode,null);},"good");
    ...
    void KeyNotExistTest(){
        SortableObjectKeyNotExistsException thrown= Assertions.assertThrows(SortableObjectKeyNotExistsException.class,
                ()-> {SortableObject So=new SortableObject(CompositeTestNode,"d");},"good");
        assertEquals(pl.put.poznan.sort.logic.exceptions.SortableObjectKeyNotExistsException.class,SortableObjectKeyNotExistsException.class);
    }
    @Test
